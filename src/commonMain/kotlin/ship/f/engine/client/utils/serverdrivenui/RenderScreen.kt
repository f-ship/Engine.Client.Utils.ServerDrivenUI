    ...
    CompositionLocalProvider(ClientProvider provides client) {
        MaterialTheme (
            ...
            AnimatedContent(
                ...
                transitionSpec = {
                    if (screenConfig.value.forward){
                        // The new screen enters from the right; old slides left out.
                        (slideInHorizontally(
                        ...
                        // The old screen enters from the left; current slides right out.
                        (slideInHorizontally(
                            initialOffsetX = { -it },          // start just off the right edge
                            animationSpec = tween(300)
                        ) + fadeIn(tween(150))) togetherWith
